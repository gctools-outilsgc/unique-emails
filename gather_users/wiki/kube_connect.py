...
class db_connection:
    ...
    def __init__(self):
        db_command = "kubectl port-forward --context AKS-collab-29-admin -n wiki " + self.__get_name() + " 3306:3306"
        self.port = 3306
    ...
    def __get_name(self):
        cmd = check_output("kubectl get pods --context AKS-collab-29-admin -n wiki", shell=True) #maintains synch order
